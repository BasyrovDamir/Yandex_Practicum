...
| [Предсказание выработки золотодобывающей компании.](Recovery of gold from ore) | Нужно построить Модель предсказания качества очистки золотоносной руды. | *pandas*, *math*, *sklearn*, *numpy* |
